  ...
  return (
    <div className="">
      <nav className="flex space-x-4 my-4">
        <a href="#all" className="text-gray-600">
          Tất cả
        </a>
        <a href="#life" className="text-gray-600">
          Đời sống
        </a>
        <a href="#travel" className="text-gray-600">
          Du lịch
        </a>
        <a href="#history" className="text-gray-600">
          Lịch sử
        </a>
        <a href="#anime" className="text-gray-600">
          Anime
        </a>
        <a href="#entertainment" className="text-gray-600">
          Giải trí
        </a>
        <a href="#education" className="text-gray-600">
          Học thuật
        </a>
      </nav>
          ...
          <div>
            ...
            {sidebarArticles.map((slidebarArticle, index) => (
              <div key={index} className="flex mb-6">
                <img
                  src={slidebarArticle.image}
                  alt={slidebarArticle.title}
                  className="w-[30%]"
                />
                <div className="my-auto ml-2">
                  <h3 className="text-[17px] font-medium">
                    {slidebarArticle.title}
                  </h3>
                  <p className="text-[12px] text-gray-500">
                    {slidebarArticle.date}
                  </p>
                </div>
              </div>
            ))}
